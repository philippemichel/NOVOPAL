...
Il s'agit d'une étude observationnelle simple pour lesquelles il est difficile de préciser un nombre de cas nécessaires en l'absence de test statistique. Néanmoins on peut estimer à environ quatre-vingt-dix cas le strict minimum nécessaire pour avoir un échantillon utilisable s'il n'y a pas trop de données manquantes.
...
Les résultats bruts seront dans le tableau 2. des liens avec les facteurs démographiques seront recherchés (test de Kruskal-Wallis ou de Student selon le nombre de catégories).
...
## Objectif 6
**Étudier le délai d’orientation vers les soins palliatif**
